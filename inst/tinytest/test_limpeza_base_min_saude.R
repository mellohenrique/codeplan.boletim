...
limpeza_teste <- codeplan.boletim::limpa_base_min_saude(teste)

expect_equal(class(codeplan.boletim::limpa_base_min_saude(teste)), "data.frame")
expect_equal(class(codeplan.boletim::limpa_base_min_saude(teste, produto_dt = TRUE)), c("data.table", "data.frame"))
